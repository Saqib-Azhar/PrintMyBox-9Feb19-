...
{
    public class DataCrawlerController : Controller
    {
        // GET: DataCrawler
        ...
        //public static async Task<string> DataCrawler()
        //{
        //    try
        //    {
        ...
        //        using (Practicing_OAuthEntities dbObj = new Practicing_OAuthEntities())
        //        {
