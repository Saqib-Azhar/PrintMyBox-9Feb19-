...
$(function () {
    ...
    myHub.client.loginResult = function (status, id, name) {
        if (status) {
            ...
            var msg = id == 'config' ?
                'No configuration file found. Please configure PrintMyBox before using it' :
    ...
    myHub.client.newChat = function (id) {
        ...
        $('#chat-sessions').prepend(
            '<div id="chat' + id + '" class="row chat-session" style="width:290px;margin-left:4px" data-id="' + id + '">' +
            '<div class="row"><div class="col-md-5"><abbr class="timeago" title="' + d.toISOString() + '">' + d.toISOString() + '</abbr></div>' +
            '<div class="col-md-7" style="text-align: right;"><a class="close-chat btn btn-mini" href="#"><span class="glyphicon glyphicon-remove"></span></a>' +
            '<p>New message(s) <span class="badge badge-warning">0</span></p></div></div>' +
            '</div>');
